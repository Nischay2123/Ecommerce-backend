...
import { calculatePercantage, getChartData, getInventories, } from "../Utils/features.utils.js";
export const getDashboardStats = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has("admin-stats")) {
        ...
        const latestTransactionPromise = Order.find({})
            ...
            .limit(4);
        const [thisMonthOrders, thisMonthProducts, thisMonthUsers, lastMonthOrders, lastMonthProducts, lastMonthUsers, productsCount, usersCount, allOrders, lastSixMonthOrder, categories, femaleUsersCount, latesTransaction,] = await Promise.all([
        ...
        const changePercent = {
            ...
            product: calculatePercantage(thisMonthProducts.length, lastMonthProducts.length),
            order: calculatePercantage(thisMonthOrders.length, lastMonthOrders.length),
            user: calculatePercantage(thisMonthUsers.length, lastMonthUsers.length),
        };
